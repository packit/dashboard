                ...
                cells: [
                    {
                        title: (
                            <ForgeIcon
                                url={upstream_downstream_job.project_url}
                            />
                        ),
                    },
                    {
                    ...
                    },
                    {
                        title: (
                            <SyncReleaseStatuses
                                statuses={
                                    upstream_downstream_job.status_per_downstream_pr
                                }
                                ids={
                                    upstream_downstream_job.packit_id_per_downstream_pr
                                }
                                job={job}
                            />
                        ),
                    },
                    {
                        title: (
                            <Timestamp
                                stamp={upstream_downstream_job.submitted_time}
                            />
                        ),
                    },
                ],
